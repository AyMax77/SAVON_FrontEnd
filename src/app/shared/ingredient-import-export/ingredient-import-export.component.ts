...
const csvData = this.ingredients.map(ing =>`${ing.id},${ing.nom},${ing.iode},${ing.ins},${ing.sapo},${ing.volMousse},${ing.tenueMousse},${ing.douceur},${ing.lavant},${ing.durete},${ing.solubilite},${ing.sechage},${ing.estCorpsGras}`
);
// Ajout de l'en-tête au CSV
const csvHeader = "ID,Nom,Indice Iode,Indice INS,Indice deSaponification,Volume de Mousse,Tenue de Mousse,Douceur,PouvoirLavant,Dureté,Solubilité,Séchage,Est Corps Gras";
